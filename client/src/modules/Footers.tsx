...
const Footers = () => {
  ...
  <div className="flex justify-center items-center space-x-1">
    ...
    <a href="https://github.com/MTthoas/ETH_GLOBAL_HNP" data-tooltip-target="tooltip-github" className="inline-flex justify-center p-2 text-gray-500 rounded-lg cursor-pointer dark:text-gray-400 dark:hover:text-white hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-600">
