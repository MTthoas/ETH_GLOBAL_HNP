      ...
      <section className="max-w-screen-xl px-5 mx-auto">
        <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
          <div className="max-w-screen-xl px-5 mx-auto">
            <div
              className="group relative w-96 h-120 flex items-end justify-start text-left bg-cover bg-center"
            ...
            <div className="flex my-6">
              <div className="py-5 pr-4">
                <button
                  type="button"
                  onClick={handleOpen}
                  className="text-white bg-green hover:bg-green/90 focus:ring-4 focus:outline-none focus:ring-[#050708]/50 font-medium rounded-lg text-sm px-5 py-3 text-center inline-flex items-center dark:focus:ring-[#050708]/50   mr-4"
                >
                ...
                <button
                  type="button"
                  className="text-dark  focus:ring-4 focus:outline-none border focus:ring-[#050708]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#050708]/50 dark:hover:bg-[#050708]/30 "
                >
                  Learn more
                </button>
              </div>
          ...
          <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
              <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                >
                  <a
                    href={`https://gateway.lighthouse.storage/ipfs/${data.justification_file_hash}`}
                    target={"_blank"}
                  >
                    {shortenString(
                      `https://gateway.lighthouse.storage/ipfs/${data.justification_file_hash}`,
                      40
                    )}
                  </a>
                </th>
                <td className="px-6 py-4">12kb</td>
                ...
                <td className="px-2 py-4 text-right">
                  <button
                    type="button"
                    className="pt-2 text-gray-900 bg-white hover:bg-gray-100 border border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-xs px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-600 dark:bg-gray-800 dark:border-gray-700  dark:hover:bg-gray-700 me-2 mb-1"
                  >
                    <svg
                      aria-hidden="true"
                  ...
                  >
                    <button
                      type="button"
                      className="bg-blue-700  underline focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2.5 text-center inline-flex items-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                    >
                      Download
                    </button>
                  </a>
