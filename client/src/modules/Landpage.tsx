      ...
      <section className="bg-white gradiant">
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12 mt-24">
          ...
          <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
            <a
              href="#"
              className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center rounded-lg bg-green text-white"
            >
            ...
            <a
              href="#"
              className="inline-flex justify-center items-center py-3 px-5 text-dark border rounded-lg"
            >
              Learn more
            </a>
          </div>
              ...
              >
                ...
                <div className="absolute top-0 right-0 left-0 mx-5 mt-2 flex justify-between items-center">
                  ...
                  <div className="text-white font-regular flex flex-col justify-start">
                    <span className="text-3xl leading-0 font-semibold">
                      {project.name}
                    </span>
                ...
                <main className="p-5 z-10">
                  ...
                  >
                    {shortenString(project.description, 30)}
                  </a>
                </main>
              </div>
            ))}
